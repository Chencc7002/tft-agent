...
export const messages = {
  "zh-CN": {
    ...
    dataInterpretation: "数据解读", generatedFromEvidence: "由数据生成", templateFallback: "已使用模板回退", nextAction: "下一步", staticEvidence: "可展开的静态证据", explanationHelpful: "解读有帮助", explanationNotHelpful: "解读需改进", cachedConclusion: "结论缓存", conclusionMissingDimensions: "当前无法判断", dimensionBuildPerformance: "装备组合表现", dimensionCoreItemTendency: "核心装备倾向", dimensionSampleRisk: "样本风险", dimensionItemPerformanceRanking: "装备表现排名", dimensionMetricReliability: "指标可靠性", dimensionTargetItemPerformance: "指定装备表现", dimensionRankingContext: "同条件排名对照", dimensionEmblemPerformanceRanking: "转职装备表现排名", dimensionComparisonResult: "装备对比结果", dimensionComparisonMetrics: "对比指标",
