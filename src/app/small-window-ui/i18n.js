...
export const messages = {
  "zh-CN": {
    ...
    trendNoneLocal: "本地 72 小时同口径数据中，暂无平均名次提升超过 0.10 的阵容。",
    trendNoneUpstream: "MetaTFT 当前没有标记排名上升的阵容。",
    ...
    quickTaskCompsTitle: "热门阵容", quickTaskCompsBody: "当前版本上分阵容排行", quickTaskTrendsTitle: "阵容趋势", quickTaskTrendsBody: "发现近期上升阵容",
    ...
    improvingComps: "近 3 天新兴强阵容", avgPlacementImproved: "平均名次提升 {value}", emergingScore: "新兴强度", emergingFormula: "排序：平均名次提升 × √登场率",
  ...
  "en-US": {
    ...
    trendNoneLocal: "No comp improved its average placement by more than 0.10 in the local same-scope 72-hour data.",
    trendNoneUpstream: "MetaTFT currently marks no comp as improving.",
    ...
    quickTaskCompsTitle: "Popular comps", quickTaskCompsBody: "Best climbing comps this patch", quickTaskTrendsTitle: "Comp trends", quickTaskTrendsBody: "Find recently rising comps",
    ...
    improvingComps: "Emerging comps (last 3 days)", avgPlacementImproved: "Avg placement improved by {value}", emergingScore: "Emergence score", emergingFormula: "Sorted by avg placement improvement × √play rate",
